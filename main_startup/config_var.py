...
class Config((object)):
    ...
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC", "https://telegra.ph/file/52bf20fcee098867f53a9.jpg"
    )
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://t.me/slogan_98/48"
    )
    ALIVE_IMG = os.environ.get(
        "ALIVE_IMG", "https://telegra.ph/file/52bf20fcee098867f53a9.jpg"
    )
    U_BRANCH = "master"
    ...
    XTRA_PLUGINS_REPO = os.environ.get("XTRA_PLUGINS_REPO", "https://t.me/slogan_98/46")
